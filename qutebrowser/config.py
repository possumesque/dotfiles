#TODO: change tab colors to something more readable
...
c.aliases = {'w': 'session-save', \
            ...
            'wq': 'quit --save', \
            'wqa': 'quit --save', \
            'cheatsheet': 'open -w qute://help/img/cheatsheet-big.png', \
            'mpv': \
                'spawn --userscript %s' % str(config.configdir / 'userscripts/view_in_mpv') \
    }
...
## Type: ShellCommand
c.editor.command = ['/home/possumesque/bin/st/st', '-c', 'editconfig', '-e', 'nvim', '{file}']
...
c.url.searchengines = {'DEFAULT': 'https://duckduckgo.com/?q={}',
        ...
        'nyaa': 'https://nyaa.si/?q={}&f=0&c=0_0'
    }
...
config.bind('<Ctrl-Y>', 'hint links yank-primary', mode='hint')
...
config.bind('<Ctrl-Shift-Tab>', 'tab-previous')
config.bind('<Ctrl-E>', 'open-editor', mode='passthrough')
# config.bind('<Ctrl-Shift-I>', \ # this breaks passthrough mode
#         'hint images ;; enter-mode passthrough', mode='passthrough')
